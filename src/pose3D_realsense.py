...
class Pose3D:
    ...
    def __init__(self, pose2D_mode = "RCNN",fps = 60, resolution = (640,480), plot3D = True, ros_pub = True, from_bag_file = False, path_to_bag = ''):
        ...
        self.keypoints_names_OpenPose_COCO = ["nose","neck","left_shoulder","left_elbow","left_wrist","right_shoulder","right_elbow",
    ...
    def initPose3DModel(self):
        model = LinearModel()
        ckpt = torch.load("~/soares_repo/HPE_Rob_Med/checkpoint/test/ckpt_best.pth.tar")
